...
$routes->post('admin/locacoes/excluir/(:num)', 'Locoes::excluir/$1');
$routes->post('admin/locacoes/finalizar/(:num)', 'Locoes::finalizar/$1');
...
$routes->post('admin/contratos/excluir/(:num)', 'Contratos::excluir/$1');
...
$routes->post('admin/manutencao-inteligente/excluir/(:num)', 'ManutencaoInteligente::excluir/$1');
...
$routes->post('admin/cadastro/produtos/excluir/(:num)', 'Produtos::excluir/$1');
...
$routes->post('admin/cadastro/servicos/excluir/(:num)', 'Servicos::excluir/$1');
...
$routes->post('admin/cadastro/categorias-financeiras/excluir/(:num)', 'CategoriasFinanceiras::excluir/$1');
