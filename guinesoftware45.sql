...
-- Tempo de geração: 16/01/2026 às 10:12
...
(18, 'Folha de pagamento', 'despesa', 1, '2026-01-14 11:03:20', '2026-01-14 11:03:20');
...
--
ALTER TABLE `categorias_financeiras`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Identificador único da categoria financeira',AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT de tabela `clientes`
--
ALTER TABLE `clientes`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Identificador único do cliente';
--
...
--
ALTER TABLE `empresas`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Identificador único da empresa (tenant do sistema)';
--
-- AUTO_INCREMENT de tabela `lancamentos_financeiros`
--
ALTER TABLE `lancamentos_financeiros`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Identificador único do lançamento financeiro';
--
-- AUTO_INCREMENT de tabela `locacoes`
--
ALTER TABLE `locacoes`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Identificador único da locação';
--
...
--
ALTER TABLE `manutencoes`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Identificador único da manutenção';
--
-- AUTO_INCREMENT de tabela `manutencoes_itens`
--
ALTER TABLE `manutencoes_itens`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Identificador único do item da manutenção';
--
...
--
ALTER TABLE `produtos`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Identificador único do produto/peça';
--
-- AUTO_INCREMENT de tabela `servicos`
--
ALTER TABLE `servicos`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Identificador único do serviço';
--
-- AUTO_INCREMENT de tabela `veiculos`
--
ALTER TABLE `veiculos`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Identificador único do veículo';
--
