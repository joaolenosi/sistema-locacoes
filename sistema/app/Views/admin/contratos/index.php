        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">Listagem de Contratos</h5>
                ...
                <p class="text-muted">
                    Gerencie todos os contratos cadastrados no sistema. Use a busca para filtrar ou clique nas colunas para ordenar.
                </p>
